module.exports = function(controller) {
    ...
    controller.hears(['goldfish'], 'message_received', function(bot, message) {

        bot.startConversation(message, function(err, convo) {

            convo.say('Did someone say goldfish!?!!');
            convo.ask('What is your favorite type of goldfish?', function(response, convo) {
